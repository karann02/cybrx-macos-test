#!/usr/bin/env bash
# =============================================================================
#  CybrxAgent DEB Install Script
#  Configures the system service account, license, and systemd unit.
#  Called automatically by the DEB postInst hook.
# =============================================================================
set -euo pipefail
...
echo ""
echo "======================================================"
echo "  $APP_NAME — Production DEB Installer"
echo "======================================================"
echo "  Binary     : $BINARY"
